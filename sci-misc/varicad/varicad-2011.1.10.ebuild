...
pkg_nofetch() {
	...
	eerror
	eerror "and download the ${PN} 2011 ${PV} package."
...
src_install() {
	...
	# installing the docs
	dodoc usr/share/doc/varicad2011-en/{README-en.txt,ReleaseNotes.txt,README.Debian,copyright,changelog.Debian.gz}
	if use doc; then
